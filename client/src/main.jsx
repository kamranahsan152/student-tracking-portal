...
function Admin(){
  ...
  const tabIcons={overview:LayoutGrid,review:Clock,rejected:XCircle,students:Users,analytics:BarChart3};
  const tabs=[['overview','Overview'],['review','Pending Review'],['rejected','Rejected'],['students','Students'],['analytics','Analytics']];
...
function Review({data,review,busy}){
  ...
  <GlassCard className="table-card"><div className="table-toolbar"><div><b>Submission review</b><span>{data.pending.length} awaiting action</span></div></div>
